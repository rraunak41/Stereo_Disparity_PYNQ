...
reg   [0:0] empty_reg_124_3;
reg    ap_block_state1_pp0_stage0_iter0;
wire   [15:0] trunc_ln414_fu_89_p1;
reg   [15:0] trunc_ln414_reg_129;
wire   [15:0] trunc_ln414_1_fu_112_p1;
reg    ap_done_reg;
...
always @ (*) begin
    if ((~((stream_out_32_TREADY == 1'b0) | (stream_in_24_TVALID == 1'b0)) & (tmp_last_V_fu_100_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign stream_out_32_TDATA = {{trunc_ln414_1_fu_112_p1}, {trunc_ln414_reg_129}};
...
assign stream_out_32_TUSER = (stream_in_24_TUSER | empty_reg_124_3);

assign tmp_last_V_fu_100_p1 = stream_in_24_TLAST;

assign trunc_ln414_1_fu_112_p1 = stream_in_24_TDATA[15:0];

assign trunc_ln414_fu_89_p1 = stream_in_24_TDATA[15:0];
